...
<body>
	...
	<?php
		...
		$res = mysql_query("SELECT title, year, rating FROM Movie WHERE company = $company;", $db_connection);

		echo "<table border=1 cellspacing=1 cellpadding=2>\n";
		echo "<tr align=center><td colspan=3><b>Movies made by company: $company_raw</b></td></tr>";
