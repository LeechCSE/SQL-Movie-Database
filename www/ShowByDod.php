...
<body>
	<h1>Based on the Date of Death</h1>
	...
	<?php
		...
		$dod = "'" . $_GET["dod"] . "'";
		$res = mysql_query("SELECT CONCAT(first, ' ', last) AS Name, sex, dod, dob, first, last FROM Actor WHERE dod = $dod;");

		echo "<table border=1 cellspacing=1 cellpadding=2>\n";
		echo "<tr align=center><td colspan=3><b>Actors of the date of death: " . $_GET["dod"] . "</b></td></tr>";
		...
		while ($row = mysql_fetch_row($res)){
			...
			echo "<td>$row[1]</td>";
			if ($row[3] != "")
				echo "<td><a href='http://localhost:1438/~cs143/ShowByDob.php?dob=$row[3]'>" . $row[3] . "</td>";
			else
				echo "<td>" . "N/A" . "</td>";
			echo "</tr>\n";
		}
