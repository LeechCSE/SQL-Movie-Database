...
<body>
	...
	<?php
		...
		$year = $_GET["year"];
		$res = mysql_query("SELECT title, rating, company FROM Movie WHERE year = $year;", $db_connection);

		echo "<table border=1 cellspacing=1 cellpadding=2>\n";
		echo "<tr align=center><td colspan=3><b>Movies made in $year</b></td></tr>";
